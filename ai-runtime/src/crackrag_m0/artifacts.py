...
def capability_snapshot() -> dict:
    return {
        "snapshot_version": "deepseek-docs-2026-09-11",
        "documentation_checked_at": "2026-09-11",
        "sources": ["https://api-docs.deepseek.com/", "https://api-docs.deepseek.com/guides/kv_cache/",
                    "https://api-docs.deepseek.com/api/create-chat-completion/",
                    "https://api-docs.deepseek.com/quick_start/pricing/"],
        "documented": {
            "protocol": "POST /chat/completions",
            "context_cache": "automatic, best effort; common prefix",
            "cache_usage_fields": ["prompt_cache_hit_tokens", "prompt_cache_miss_tokens"],
            "json_object_mode": "documented; schema is checked locally",
            "default_model_at_documentation_check": "deepseek-flash",
        },
        "empirically_verified": False,
        "reusable_signal": "unknown", "ttl_seconds": None,
        "cache_key": None, "cache_only_reservation": "unknown",
        "gpu_location": "unknown", "json_schema_support": "not_tested",
        "schema_cache_compatibility": "not_tested",
        "note": "Documentation is not evidence that any individual call hit cache.",
    }
...
class RunStore:
    def __init__(self, config: Config, run_id: str, prefix: FrozenPrefix,
        ...
        versions = {}
        for name in ("httpx", "httpcore", "python-dotenv", "anyio", "certifi", "h11", "idna"):
            try:
